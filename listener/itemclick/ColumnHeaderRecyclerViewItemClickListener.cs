...
namespace Com.Evrencoskun.Tableview.Listener.Itemclick
{
    ...
    public class ColumnHeaderRecyclerViewItemClickListener : AbstractItemClickListener
    {
        ...
        protected internal override void LongPressAction(MotionEvent e)
        {
            ...
            if (child != null && GetTableViewListener() != null)
            {
                ...
                GetTableViewListener().OnColumnHeaderLongPressed(holder, holder.AdapterPosition);
            }
        }
    }
}
